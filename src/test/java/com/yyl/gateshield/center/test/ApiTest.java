...
public class ApiTest {
    ...
    public void test_registerApplication() {
        ...
        applicationSystemVO.setSystemId("api-gateshield-test");
    ...
    public void test_registerApplicationInterface() {
        ...
        applicationInterfaceVO.setSystemId("api-gateshield-test");
        applicationInterfaceVO.setInterfaceId("com.yyl.gateshield.rpc.IActivityBooth");
        applicationInterfaceVO.setInterfaceName("活动平台");
        applicationInterfaceVO.setInterfaceVersion("1.0.0");
    ...
    public void test_registerApplicationInterfaceMethod() {
        ...
        applicationInterfaceVO01.setSystemId("api-gateshield-test");
        applicationInterfaceVO01.setInterfaceId("com.yyl.gateshield.rpc.IActivityBooth");
        ...
        applicationInterfaceVO02.setSystemId("api-gateshield-test");
        applicationInterfaceVO02.setInterfaceId("com.yyl.gateshield.rpc.IActivityBooth");
        applicationInterfaceVO02.setMethodId("insert");
        applicationInterfaceVO02.setMethodName("插入方法");
        applicationInterfaceVO02.setParameterType("com.yyl.gateshield.rpc.dto.XReq");
